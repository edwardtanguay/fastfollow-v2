    ...
    <div className="min-h-dvh text-gray-100 p-8 md:p-12">
      <div className="max-w-7xl mx-auto mt-16 md:mt-8">
        <header className="mb-16 relative">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold py-4 -my-4 mb-2 tracking-tight bg-linear-to-r from-blue-400 via-indigo-400 to-purple-500 bg-clip-text text-transparent leading-tight">
            AI Ecosystem
          </h1>
